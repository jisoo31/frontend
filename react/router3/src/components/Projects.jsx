...
export default function Projects() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: 'Analytics dashboard for social media metrics with data visualization, export features, and customizable reports.',
    ...
    {
      title: 'Weather App',
      description: 'Beautiful weather application with forecast data, interactive maps, and location-based services.',
    ...
    },
    {
      ...
      description: 'Responsive portfolio website with animations, dark mode, and modern UI/UX design.',
    ...
    },
    {
      ...
      description: 'Real-time chat application with rooms, file sharing, emoji support, and message history.',
      tech: ['Socket.io', 'Node.js', 'React'],
      image: 'https://images.unsplash.com/photo-1586999768265-24af89630739?w=800',
      github: 'https://github.com',
      demo: 'https://example.com'
    }
  ] ;
                ...
                {projects.map((project, index)=>(
                    ...
                    >
                        <div class="project-image-container">
                            ...
                            {/* hover overLay */}
                            {hoveredIndex === index && (
                                //카드에 호버시 순회하는 인덱스 번호와 호버시 인덱스 번호가 같으면 실행
